...
# ==========================================
# 1. CẤU HÌNH & CSS (GIỮ NGUYÊN STYLE CŨ)
# ==========================================
...
def load_resnet50_model():
    ...
    try:
        ...
        st.error(f"⚠️streamlit run app.py LỖI: Không tìm thấy file '{model_path}'. Vui lòng copy file model vào cùng thư mục với file code này.")
        return None
...
with head_c2 :
    ...
    #  file logo của trường 
    st.markdown("<h3 style= 'text-align: center' > TRƯỜNG ĐẠI HỌC KHOA HỌC TỰ NHIÊN TP.HỒ CHÍ MINH </h3>", unsafe_allow_html= True)
    st.markdown("<h3 style='text-align: center; color: #01579B;'>HỆ THỐNG PHÂN LOẠI MÀU NƯỚC AO NUÔI</h3>", unsafe_allow_html=True)
    st.markdown("<h5 style='text-align: center; color: #0288D1;'>SỬ DỤNG MÔ HÌNH HỌC SÂU RESNET-50</h5>", unsafe_allow_html=True)
    st.markdown("<p style='text-align: center; font-style: italic; color: grey;'>Đồ án chuyên đề - Hồ Thị Như Nguyệt</p>", unsafe_allow_html=True)

st.divider()

st.write("📸 **Hướng dẫn:** Vui lòng tải lên hình ảnh bề mặt nước ao nuôi để hệ thống phân tích.")
        ...
        with c2:
            with st.spinner('Đang xử lý qua mạng ResNet50...'):
                ...
                if model is not None:
                    ...
                    # Gợi ý xử lý, đoạn này mom chỉnh xong cái giao diện òi mom bỏ giùm t đoạn này nha. iu lúmmm
                    st.info("**Đánh giá sơ bộ:**")
                    if "Label 1" in pred_label or "Label 2" in pred_label:
                        st.write("⚠️ Nước có màu vàng/vàng nhạt. Cảnh báo tảo tàn hoặc ô nhiễm hữu cơ. Cần kiểm tra pH và thay nước.")
                    elif "Label 3" in pred_label:
                        st.write("✅ Màu nước Vàng Xanh (Màu trà). Đây là màu nước tốt nhất cho tôm/cá phát triển.")
                    else:
                        st.write("⚠️ Nước màu xanh biển/trong. Thiếu dinh dưỡng, thiếu tảo. Cần gây màu nước lại.") 